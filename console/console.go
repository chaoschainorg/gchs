...
func (c *Console) initWeb3(bridge *bridge) error {
	...
	helperJS := string(deps.MustAsset("helper.js"))
	...
	if err := c.jsre.Compile("helper.js", helperJS); err != nil {
		return fmt.Errorf("helper.js: %v", err)
	}
...
// Welcome show summary of current Gchs instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gchs JavaScript console!\n\n"

	// Print some generic Gchs metadata
